    ...
    <div className={styles.box}>
     ...
     minScale={1} 
        ...
        <div className={styles.imageWrapper}>
          ...
          >
            <path
              className={styles.hoverablePath4}
